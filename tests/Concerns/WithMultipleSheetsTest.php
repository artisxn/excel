...
use codicastudio\Excel\Tests\Data\Stubs\SheetForUsersFromView;
use codicastudio\Excel\Tests\Data\Stubs\SheetWith100Rows;
...
class WithMultipleSheetsTest extends TestCase
{
    ...
    {
        $this->expectException(\codicastudio\Excel\Exceptions\SheetNotFoundException::class);
