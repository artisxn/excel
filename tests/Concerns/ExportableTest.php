...
class ExportableTest extends TestCase
{
    ...
    {
        $this->expectException(\codicastudio\Excel\Exceptions\NoFilenameGivenException::class);
    ...
    {
        $this->expectException(\codicastudio\Excel\Exceptions\NoFilePathGivenException::class);
