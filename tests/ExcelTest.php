...
use codicastudio\Excel\Facades\Excel as ExcelFacade;
use codicastudio\Excel\Importer;
use codicastudio\Excel\Tests\Data\Stubs\EmptyExport;
use codicastudio\Excel\Tests\Helpers\FileHelper;
...
class ExcelTest extends TestCase
{
    ...
    {
        $this->expectException(\codicastudio\Excel\Exceptions\ConcernConflictException::class);
    ...
    {
        $this->expectException(\codicastudio\Excel\Exceptions\NoTypeDetectedException::class);
